...
const artParts = {
  ...
  line: `
    ...
    <path d="M95 95 L70 40 L125 85 Z" />
    <path d="M205 95 L230 40 L175 85 Z" />

    <circle cx="120" cy="140" r="8" />
    <circle cx="180" cy="140" r="8" />

    <path d="M150 160 L140 175 L160 175 Z" />

    <path d="M150 175 C135 190 120 194 105 190" />
    <path d="M150 175 C165 190 180 194 195 190" />

    <path d="M140 170 H90" />
    <path d="M140 180 H90" />

    <path d="M160 170 H210" />
    <path d="M160 180 H210" />
  `,

  mask: `
    <circle fill="#000" cx="150" cy="150" r="88" />

    <path fill="#000"
      d="M95 95 L70 40 L125 85 Z" />

    <path fill="#000"
      d="M205 95 L230 40 L175 85 Z" />
  `
},
  rabbit: {
  ...
  line: `
    ...
    <circle cx="185" cy="85" r="30" />
    <circle cx="185" cy="155" r="30" />
    <circle cx="115" cy="155" r="30" />
    <circle cx="115" cy="85" r="30" />

    <path d="M150 170 V290" />

    <path d="M150 220
             C110 190 70 200 55 235
             C100 250 135 245 150 220 Z" />

    <path d="M150 245
             C190 210 230 220 245 255
             C200 270 165 265 150 245 Z" />
  `,

  mask: `
    <circle fill="#000" cx="150" cy="120" r="35" />

    <circle fill="#000" cx="150" cy="70" r="38" />
    <circle fill="#000" cx="200" cy="120" r="38" />
    <circle fill="#000" cx="150" cy="170" r="38" />
    <circle fill="#000" cx="100" cy="120" r="38" />

    <circle fill="#000" cx="185" cy="85" r="38" />
    <circle fill="#000" cx="185" cy="155" r="38" />
    <circle fill="#000" cx="115" cy="155" r="38" />
    <circle fill="#000" cx="115" cy="85" r="38" />
  ...
  rainbow: {
  line: `
    <path d="M40 240 C40 120 95 50 150 50 C205 50 260 120 260 240" />
    <path d="M75 240 C75 145 108 95 150 95 C192 95 225 145 225 240" />
    <path d="M110 240 C110 175 128 135 150 135 C172 135 190 175 190 240" />
    <path d="M40 240 H260" />
  `,
  ...
  mask: `
    <path fill="#000"
      d="
      M40 240
      C40 120 95 50 150 50
      C205 50 260 120 260 240

      L225 240

      C225 145 192 95 150 95
      C108 95 75 145 75 240
    ...
    <path fill="#000"
      d="
      M75 240
      C75 145 108 95 150 95
      C192 95 225 145 225 240

      L190 240

      C190 175 172 135 150 135
      C128 135 110 175 110 240
    ...
    <path fill="#000"
      d="
      M110 240
      C110 175 128 135 150 135
      C172 135 190 175 190 240
